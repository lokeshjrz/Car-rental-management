...
brands_choice = []
for brand in brands_and_models:
    brands_choice.append((brand, brand))
brands_choice = tuple(brands_choice)

transmission_choice = (('manual', 'manual'), ('automatic', 'automatic'))

currency_choice = (('USD', 'USD'), ('EUR', 'EUR'), ('BYN', 'BYN'), ('RUB', 'RUB'))
